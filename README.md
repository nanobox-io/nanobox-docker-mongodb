...
To create and publish the image to nanobox/mongodb simply run      
...
you can `vagrant ssh` and run `docker tag nanobox/mongodb ${YOUR_USER}/mongodb`      
then push with `docker push ${YOUR_USER}/mongodb`   
